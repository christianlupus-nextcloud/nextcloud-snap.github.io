...
I like `nextcloud-snap` but I needed more control over my installation  If you are using `nextcloud-snap` and you want to migrate to Nextcloud server here are some notes how one user did it:
...
Don't.  Wait until you import the old database below.
...
#### NOW secure the mariaDB install
